...
public final class FuxModuleManager {
    ...
    public static void init(){
        ...
        MODULES.add(new FuxSprintModule()); MODULES.add(new FuxAutoWalkModule()); MODULES.add(new FuxAutoJumpModule());
        MODULES.add(new FuxFovModule()); MODULES.add(new FuxFullbrightModule()); MODULES.add(new FuxNoFallModule());
        MODULES.add(new FuxVelocityModule()); MODULES.add(new FuxTrailModule()); MODULES.add(new FuxBambooHatModule());
        MODULES.add(new FuxChinaCloudsModule()); MODULES.add(new FuxHitParticlesModule()); MODULES.add(new FuxTargetEspModule());
        MODULES.add(new FuxDamageNumbersModule()); MODULES.add(new FuxTrajectoryModule());
    }
